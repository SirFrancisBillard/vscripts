...
::MusicalChairsRound <- function()
{
	...
	if (players.len() > 1)
	{
		...
		while (chair = Entities.FindByName(chair, "musical_chairs"))
			chairs.push(chair)
		for (local i = 0; i < players.len() - 2; i++)
		{
...
::GiveKnifeLoadout <- function(ply, num = 0)
{
	...
	switch (num)
	{
		...
		case 4:
			GiveWeapons(ply, ["item_assaultsuit", "weapon_bayonet", "weapon_elite", "weapon_shield"])
			break

		default:
			GiveWeapons(ply, ["item_assaultsuit", "weapon_knife", "weapon_p250"])
			break
	}
	MeleeFixup()
}
...
::GiveVampireSlayerLoadout <- function(ply, num = 0)
{
	...
	{
		case 1:
			GiveWeapons(ply, ["item_assaultsuit", "weapon_knife_m9_bayonet", "weapon_nova", "weapon_breachcharge", "weapon_hegrenade"])
			break

		case 2:
			GiveWeapons(ply, ["item_assaultsuit", "weapon_knife_butterfly", "weapon_awp", "weapon_hegrenade"])
			break

		case 3:
			GiveWeapons(ply, ["item_assaultsuit", "weapon_knife_karambit", "weapon_deagle", "weapon_bumpmine", "weapon_hegrenade"])
			break

		case 4:
			GiveWeapons(ply, ["item_assaultsuit", "weapon_bayonet", "weapon_shield", "weapon_hegrenade"])
			break

		default:
			GiveWeapons(ply, ["item_assaultsuit", "weapon_knife", "weapon_hegrenade"])
			break
	}
	MeleeFixup()
}
